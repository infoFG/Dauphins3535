const translations = {
  fr: {
    ...
    "cultural_calendar_p1": "Le programme de soutien aux actions culturelles du Plateau (PSAC) propose une programmation variée, festive, gratuite et qui saura ravir tous les publics. <a href='https://montreal.ca/articles/de-la-culture-partout-et-pour-tout-le-monde-sur-le-plateau-47212' target='_blank' rel='noopener'>En voici un aperçu <span style='font-size:0.85em;'>→</span></a>",
    ...
    "robin_p1": "Le Robin des Bois est un restaurant bienfaiteur fondé en 2006, qui soutient la réinsertion sociale, la lutte contre l'isolement et la pauvreté. Il est installé au Chalet du Parc Lafontaine depuis quelques années et offre, en plus des créations de sa cuisine, une programmation culturelle tout azimuts. <a href='https://robindesbois.ca/programmation/' target='_blank' rel='noopener'>Voir la programmation <span style='font-size:0.85em;'>→</span></a>",
  ...
  en: {
    ...
    "neighborhood_intro": "The Plateau-Mont-Royal is a dynamic neighbourhood with a variety of green spaces, local shops, and a diverse cultural offering. Les Dauphins is within walking distance of the commercial arteries of Ontario Street and Mont-Royal Avenue, with the pedestrianization of the latter from June to September adding to the quality of life in the neighbourhood. On Gauthier Street right next door, you'll find a grocery store, a pet supplies shop, a bakery, and a restaurant.",
    "neighborhood_p1": "La Fontaine Park, located across from the building, is a green haven at the heart of Plateau-Mont-Royal. It is a refuge for abundant urban wildlife, home to colonies of ducks and bats along its two ponds, as well as an army of generally harmless squirrels. It occasionally receives visits from great herons, cormorants and birds of prey.<br><br>Here is an overview of what the park offers visitors.",
    ...
    "theater_p1": "Located in the heart of La Fontaine Park, Théâtre de Verdure offers a free outdoor program throughout the summer. Music, dance, circus, theatre, and film are presented in this 2,000-seat amphitheatre. <a href='https://montreal.ca/lieux/theatre-de-verdure' target='_blank' rel='noopener'>Check the program <span style='font-size:0.85em;'>→</span></a>",
    "robin_p1": "Robin des Bois is a charitable restaurant founded in 2006 that supports social reintegration and the fight against isolation and poverty. It has been located in the Chalet du Parc Lafontaine for several years and offers, in addition to its culinary creations, a great line up of talents. <a href='https://robindesbois.ca/programmation/' target='_blank' rel='noopener'>View the program <span style='font-size:0.85em;'>→</span></a>",
