const translations = {
  fr: {
    ...
    "borough_calendar_p1": "L'arrondissement propose un grand nombre d'activités dont des balades à vélo, marchés fermiers et du cinéma en plein air. Plusieurs de celles-ci sont encadrées par l'administration de l'arrondissement. <a href='https://montreal.ca/evenements?dc_coverage.boroughs.code=PMR&amp;orderBy=dc_temporal.start' target='_blank' rel='noopener'>Consulter la liste complète ici <span style='font-size:0.85em;'>→</span></a>",
  ...
  en: {
    ...
    "borough_calendar_p1": "The borough offers a wide range of activities including bike rides, farmers' markets, and outdoor cinema. Many of these are organized by the borough administration. <a href='https://montreal.ca/evenements?dc_coverage.boroughs.code=PMR&amp;orderBy=dc_temporal.start' target='_blank' rel='noopener'>View the full list here <span style='font-size:0.85em;'>→</span></a>",
