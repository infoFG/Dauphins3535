const translations = {
  fr: {
    ...
    "neighborhood_p1": "Le parc La Fontaine, situé en face de l'immeuble, est un véritable poumon vert au cœur du Plateau-Mont-Royal. C'est un refuge pour une véritable faune urbaine en bordure de ses deux bassins, et abrite des colonies de canards, écureuils et chauves-souris. À l'occasion il reçoit des visites de grands hérons, de cormorans et d'oiseaux de proie.<br><br>Voici un aperçu de ce que le parc offre aux visiteurs.",
  ...
  en: {
    ...
    "neighborhood_p1": "La Fontaine Park, located across from the building, is a true green lung at the heart of Plateau-Mont-Royal. It is a haven for urban wildlife along its two ponds, home to colonies of ducks, squirrels and bats. It occasionally receives visits from great herons, cormorants and birds of prey.<br><br>Here is an overview of what the park offers visitors.",
